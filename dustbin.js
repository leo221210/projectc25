class dustbin
{
	constructor(x,y)
	{
        ...
        this.rightbody=Bodies.rectangle(x+90-40, y-60-10-50,20,100, options)
        this.centerbody=Bodies.rectangle(x, y-60,130,20, options)
	...
	display()
	{
            ...
            rect(this.leftbody.position.x,this.leftbody.position.y,5,100)
            rect(this.rightbody.position.x,this.rightbody.position.y,5,100)
